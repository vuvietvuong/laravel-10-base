          ...
          <div class="col-md-6 col-12 mb-md-0 mb-4">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex mb-3">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('img/icons/brands/slack.png') }}" alt="slack" class="me-3" height="30" />
                  </div>
                  <div class="flex-grow-1 row">
                    <div class="col-9 mb-sm-0 mb-2">
                ...
                <div class="d-flex mb-3">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('img/icons/brands/github.png') }}" alt="github" class="me-3" height="30" />
                  </div>
                  <div class="flex-grow-1 row">
                    <div class="col-9 mb-sm-0 mb-2">
                ...
                <div class="d-flex mb-3">
                  <div class="flex-shrink-0">
                    <img
                      src="{{ asset('img/icons/brands/mailchimp.png') }}"
                      alt="mailchimp"
                      class="me-3"
                      height="30"
                    />
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('img/icons/brands/asana.png') }}" alt="asana" class="me-3" height="30" />
                  </div>
                  <div class="flex-grow-1 row">
                    <div class="col-9 mb-sm-0 mb-2">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="d-flex mb-3">
                  <div class="flex-shrink-0">
                    <img
                      src="{{ asset('img/icons/brands/dribbble.png') }}"
                      alt="dribbble"
                      class="me-3"
                      height="30"
                    />
